...
upAndAchiev.push(Game.TieredUpgrade('Macrocosmics','<q>According to the theory of nanocosmics, our universe is just a subatomic particle in another universe, maybe even a subatomic particle in a living organism.</q>','Converter',7));
...
upAndAchiev.push(Game.TieredUpgrade('Ig Nobel Prize','<q>Why reward only your actions and make people skeptical, when you can reward all mundane events that happen?</q>this is a real thing I promise','Converter',10));
...
upAndAchiev.push(Game.TieredUpgrade('Unsweetened quarks','<q>Filler for your cookies. It doesn\'t taste like anything, but they won\'t notice.</q>','Converter',15));

upAndAchiev.push(Game.TieredAchievement('','','Converter',1));
upAndAchiev.push(Game.TieredAchievement('','','Converter',2));
upAndAchiev.push(Game.TieredAchievement('','','Converter',3));
upAndAchiev.push(Game.TieredAchievement('','','Converter',4));
upAndAchiev.push(Game.TieredAchievement('','','Converter',5));
upAndAchiev.push(Game.TieredAchievement('','','Converter',6));
upAndAchiev.push(Game.TieredAchievement('','','Converter',7));
upAndAchiev.push(Game.TieredAchievement('','','Converter',8));
upAndAchiev.push(Game.TieredAchievement('','','Converter',9));
upAndAchiev.push(Game.TieredAchievement('','','Converter',10));
upAndAchiev.push(Game.TieredAchievement('','','Converter',11));
upAndAchiev.push(Game.TieredAchievement('','','Converter',12));
upAndAchiev.push(Game.TieredAchievement('','','Converter',13));
upAndAchiev.push(Game.TieredAchievement('','','Converter',14));
upAndAchiev.push(Game.TieredAchievement('','','Converter',15));
